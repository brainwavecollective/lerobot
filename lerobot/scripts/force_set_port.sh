...
echo "
===========================================================
LeRobot USB Port Configuration Script
===========================================================
WARNING: I made this for my Raspberry Pi and have made absolutely no effort whatsoever 
to ensure that this works on any other system.

If this does not work for you, here are the manual steps:
...
6. update your LeRobot config to use the symlink
...
echo """
Configuration complete! Follow these steps to implement:
===========================================================
